    ...
    public function testAddSitelinks()
    {
        ...
        $sitelinksSets = SitelinksSets::make(
            ...
            SitelinksSet::make()->setSitelinks(
                Sitelinks::make(
                    Sitelink::make()
                        ->setTitle('My other first link')
                        ->setDescription('My first link description')
                        ->setHref('https://mysite.com/demo-page-3'),
                    Sitelink::make()
                        ->setTitle('My other second link')
                        ->setDescription('My second link description')
                        ->setHref('https://mysite.com/demo-page-4')
                )
            )
        );
        ...
        return self::$sitelinksSets = self::$checklists->checkModelCollection($sitelinksSets, [
            'Id' => 'integer',
