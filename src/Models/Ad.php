 ...
 * @method            $this                    setTextAd(TextAd|array $textAd)
 * @method            TextAd                   getTextAd()
 * @method            $this                    setMobileAppAd(MobileAppAd|array $mobileAppAd)
 * @method            MobileAppAd              getMobileAppAd()
 * @method            $this                    setDynamicTextAd(DynamicTextAd|array $dynamicTextAd)
 * @method            DynamicTextAd            getDynamicTextAd()
 * @method            $this                    setTextImageAd(TextImageAd|array $textImageAd)
 * @method            TextImageAd              getTextImageAd()
 * @method            $this                    setMobileAppImageAd(MobileAppImageAd|array $mobileAppImageAd)
 * @method            MobileAppImageAd         getMobileAppImageAd()
 * @method            $this                    setTextAdBuilderAd(TextAdBuilderAd|array $textAdBuilderAd)
 * @method            TextAdBuilderAd          getTextAdBuilderAd()
 * @method            $this                    setMobileAppAdBuilderAd(MobileAppAdBuilderAd|array $mobileAppAdBuilderAd)
 * @method            MobileAppAdBuilderAd     getMobileAppAdBuilderAd()
 * @method            $this                    setCpmBannerAdBuilderAd(CpmBannerAdBuilderAd|array $cpmBannerAdBuilderAd)
 * @method            CpmBannerAdBuilderAd     getCpmBannerAdBuilderAd()
 * @method            $this                    setCpcVideoAdBuilderAd(CpcVideoAdBuilderAd|array $cpcVideoAdBuilderAd)
 * @method            CpcVideoAdBuilderAd      getCpcVideoAdBuilderAd()
 * @method            $this                    setCpmVideoAdBuilderAd(CpmVideoAdBuilderAd|array $cpmVideoAdBuilderAd)
